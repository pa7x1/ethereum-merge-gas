...
block_data_fp = Path('../../static/pos.json')
GWEI = 1_000_000_000
...
fig = px.histogram(x=df['timestampDiff'], histnorm='percent', title="Ethereum Proof of Stake - Block Time Histogram", text_auto=True)
fig.update_xaxes(title_text='Block Time (s)', dtick=12)
